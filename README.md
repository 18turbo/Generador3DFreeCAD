...
Luego crea una macro con el contenido del archivo principal "Generador3D_0.0.13_BETA.FCMacro" (el número corresponde a la versión), y asígnale el icono SVG proporcionado.
